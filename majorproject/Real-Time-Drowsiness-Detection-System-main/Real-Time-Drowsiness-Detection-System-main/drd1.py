...
time.sleep(1.0)
# # Dynamic resolution scaling parameters
# original_width = cv2.VideoCapture(0).get(cv2.CAP_PROP_FRAME_WIDTH)
# original_height = cv2.VideoCapture(0).get(cv2.CAP_PROP_FRAME_HEIGHT)
# frame_width = int(original_width*0.8)
# frame_height = int(original_height*0.8)
